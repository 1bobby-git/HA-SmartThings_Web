...
REPOSITORY = "HA-SmartThings_Web"
ARCHITECTURE_TEXT = "amd64 and aarch64"
ARCHITECTURE_BADGE = "amd64%20%7C%20aarch64"
ARCHITECTURE_LINK = "https://github.com/1bobby-git/HA-SmartThings_Web/blob/main/addon/smartthings_web_bridge/config.yaml"
