...
- `0.1.84`는 캡처 경계에서 두 번 익명화된 device ID와 DeviceStore까지 거친 component/capability의 모든 실제 별칭 단계를 원본 식별자의 휘발성 메모리 매핑에 연결해, 공개 inventory 별칭으로 시작한 첫 제어도 웹 직접 명령 경로를 사용합니다.
