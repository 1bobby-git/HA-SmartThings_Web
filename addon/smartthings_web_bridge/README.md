...
For a passive soak from inside the production-pruned add-on container, use `node dist/tools/haos-soak.js --local-bridge`. The equivalent package script is `npm run soak:haos:addon`.
