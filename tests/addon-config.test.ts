...
describe("Home Assistant add-on metadata", () => {
  test("packages Home Monitor, scene and Web-label fixes as version 0.1.180", () => {
    ...
    expect(config.version).toBe("0.1.180");
    ...
    expect(packageMetadata.version).toBe("0.1.180");
    expect(protocolMetadata.bridge_version).toBe("0.1.180");
