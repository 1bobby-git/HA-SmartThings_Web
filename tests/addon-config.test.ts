...
describe("Home Assistant add-on metadata", () => {
  test("publishes the safe transient-snapshot and toggle repair as version 0.1.49", () => {
    ...
    expect(config.version).toBe("0.1.49");
    expect(packageMetadata.version).toBe("0.1.49");
    expect(protocolMetadata.bridge_version).toBe("0.1.49");
    expect(protocolMetadata.protocol_version).toBe(4);
    expect(runtime).toContain('const bridgeVersion = "0.1.49";');
    expect(changelog).toContain("## 0.1.49");
