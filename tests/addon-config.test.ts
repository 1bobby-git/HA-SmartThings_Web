...
describe("Home Assistant add-on metadata", () => {
  test("packages Advanced command parity as version 0.1.156", () => {
    ...
    expect(config.version).toBe("0.1.156");
    expect(config.homeassistant_api).toBe(true);
    expect(packageMetadata.version).toBe("0.1.156");
    expect(protocolMetadata.bridge_version).toBe("0.1.156");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "0.1.156";');
