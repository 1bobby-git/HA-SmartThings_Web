...
describe("Home Assistant add-on metadata", () => {
  test("packages HAOS session continuity as version 1.8.55", () => {
    ...
    expect(config.version).toBe("1.8.55");
    ...
    expect(packageMetadata.version).toBe("1.8.55");
    expect(protocolMetadata.bridge_version).toBe("1.8.55");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "1.8.55";');
    expect(changelog).toContain("## 1.8.55");
