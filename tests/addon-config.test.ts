...
describe("Home Assistant add-on metadata", () => {
  test("publishes the exact device targeting fix as version 0.1.35", () => {
    ...
    expect(config.version).toBe("0.1.35");
    expect(packageMetadata.version).toBe("0.1.35");
    expect(protocolMetadata.bridge_version).toBe("0.1.35");
    expect(protocolMetadata.protocol_version).toBe(1);
    expect(runtime).toContain('const bridgeVersion = "0.1.35";');
    expect(changelog).toContain("## 0.1.35");
