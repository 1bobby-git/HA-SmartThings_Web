...
describe("Home Assistant add-on metadata", () => {
  test("packages HAOS live-control recovery as version 0.1.183", () => {
    ...
    expect(config.version).toBe("0.1.183");
    ...
    expect(packageMetadata.version).toBe("0.1.183");
    expect(protocolMetadata.bridge_version).toBe("0.1.183");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "0.1.183";');
