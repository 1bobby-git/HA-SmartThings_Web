...
describe("Home Assistant add-on metadata", () => {
  test("packages HAOS live-control recovery as version 1.8.5", () => {
    ...
    expect(config.version).toBe("1.8.5");
    ...
    expect(packageMetadata.version).toBe("1.8.5");
    expect(protocolMetadata.bridge_version).toBe("1.8.5");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "1.8.5";');
