...
describe("Home Assistant add-on metadata", () => {
  test("packages HAOS live-control recovery as version 1.8.24", () => {
    ...
    expect(config.version).toBe("1.8.24");
    ...
    expect(packageMetadata.version).toBe("1.8.24");
    expect(protocolMetadata.bridge_version).toBe("1.8.24");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "1.8.24";');
    expect(changelog).toContain("## 1.8.24");
