...
describe("Home Assistant add-on metadata", () => {
  test("publishes safe pushed sensor typing as version 0.1.67", () => {
    ...
    expect(config.version).toBe("0.1.67");
    expect(packageMetadata.version).toBe("0.1.67");
    expect(protocolMetadata.bridge_version).toBe("0.1.67");
    expect(protocolMetadata.protocol_version).toBe(4);
    expect(runtime).toContain('const bridgeVersion = "0.1.67";');
    expect(changelog).toContain("## 0.1.67");
