...
describe("Home Assistant add-on metadata", () => {
  test("publishes the restart-safe UI command repair as version 0.1.46", () => {
    ...
    expect(config.version).toBe("0.1.46");
    expect(packageMetadata.version).toBe("0.1.46");
    expect(protocolMetadata.bridge_version).toBe("0.1.46");
    expect(protocolMetadata.protocol_version).toBe(3);
    expect(runtime).toContain('const bridgeVersion = "0.1.46";');
    expect(changelog).toContain("## 0.1.46");
