...
describe("Home Assistant add-on metadata", () => {
  test("publishes frozen room-prefixed entity ID repair as version 0.1.101", () => {
    ...
    expect(config.version).toBe("0.1.101");
    expect(packageMetadata.version).toBe("0.1.101");
    expect(protocolMetadata.bridge_version).toBe("0.1.101");
    expect(protocolMetadata.protocol_version).toBe(4);
    expect(runtime).toContain('const bridgeVersion = "0.1.101";');
