...
describe("Home Assistant add-on metadata", () => {
  test("packages HAOS session continuity as version 1.8.40", () => {
    ...
    expect(config.version).toBe("1.8.40");
    ...
    expect(packageMetadata.version).toBe("1.8.40");
    expect(protocolMetadata.bridge_version).toBe("1.8.40");
    expect(protocolMetadata.protocol_version).toBe(5);
    expect(runtime).toContain('const bridgeVersion = "1.8.40";');
    expect(changelog).toContain("## 1.8.40");
    expect(changelog).toContain("## 1.8.38");
    ...
    expect(changelog).toContain("## 1.8.4");
    expect(changelog).toContain("## 0.1.183");
    ...
    expect(changelog).toContain("## 0.1.154");
    expect(changelog).toContain("## 0.1.153");
    expect(changelog).toContain("childDeviceIds");
    expect(changelog).toContain("연속 on/off");
    expect(changelog).toContain("## 0.1.152");
    expect(changelog).toContain("Location-native child control");
    expect(changelog).toContain("Advanced status");
    expect(changelog).toContain("## 0.1.151");
    expect(changelog).toContain("composite parent");
    expect(changelog).toContain("child main");
    expect(changelog).toContain("## 0.1.150");
    expect(changelog).toContain("one-based ordinal");
    expect(changelog).toContain("fixed transport error code");
    expect(changelog).toContain("## 0.1.149");
    expect(changelog).toContain("persisted Location");
    expect(changelog).toContain("explicit offline");
    expect(changelog).toContain("## 0.1.148");
    expect(changelog).toContain("component transaction");
    expect(changelog).toContain("timestamp 없는 Advanced `OFFLINE`");
    expect(changelog).toContain("원래 상태 벡터");
    ...
    expect(changelog).toContain("기존 entity/config/device identity");
    expect(changelog).toContain("## 0.1.145");
    expect(changelog).toContain("primary control entities");
    expect(changelog).toContain("mapped device icon");
    expect(changelog).toContain("## 0.1.144");
    expect(changelog).toContain("repeated registry migrations");
    expect(changelog).toContain("without accumulating duplicate suffixes");
    expect(changelog).toContain("## 0.1.143");
    expect(changelog).toContain("reserved `main` presence role");
    expect(changelog).toContain("SmartThings location name");
    expect(changelog).toContain("## 0.1.142");
    expect(changelog).toContain("current Advanced component roles");
    expect(changelog).toContain("current ready inventory");
    expect(changelog).toContain("Move Refresh buttons into device settings");
    expect(changelog).toContain("redundant `_switch` suffix");
    expect(changelog).toContain("## 0.1.141");
    expect(changelog).toContain("same-origin `/location` GET");
    expect(changelog).toContain("Do not navigate, reload, inspect DOM state, read cookies");
    expect(changelog).toContain("Skip the touch while commands");
    expect(changelog).toContain("## 0.1.140");
    expect(changelog).toContain("same snapshot epoch");
    expect(changelog).toContain("preserve restored exact controls");
    expect(changelog).toContain("actual fallback URLs");
    expect(changelog).toContain("## 0.1.139");
    expect(changelog).toContain("plural `actions`");
    expect(changelog).toContain("observed `commands` or `supportedCommands`");
    expect(changelog).toContain("non-`on`/`off` commands");
    ...
    expect(changelog).toContain("## 0.1.134");
    expect(changelog).toContain("restored `unavailable` state");
    expect(changelog).toContain("registry-owned IDs");
    ...
    expect(changelog).toContain("## 0.1.130");
    expect(changelog).toContain("SmartThings Socket.IO connection");
    expect(changelog).toContain("unrelated WebSocket traffic");
    expect(changelog).toContain("## 0.1.129");
    expect(changelog).toContain("same-name devices");
    expect(changelog).toContain("## 0.1.128");
    expect(changelog).toContain("transliterated role suffixes");
    expect(changelog).toContain("## 0.1.127");
    expect(changelog).toContain("scene execution");
    expect(changelog).toContain("confirmation timeout");
    expect(changelog).toContain("## 0.1.126");
    expect(changelog).toContain("camera image cache");
    expect(changelog).toContain("`type: \"image\"`");
    expect(changelog).toContain("## 0.1.125");
    expect(changelog).toContain("## 0.1.118");
    expect(changelog).toContain("`/automations`");
    expect(changelog).toContain("## 0.1.117");
    expect(changelog).toContain("process RSS");
    expect(changelog).toContain("## 0.1.116");
    expect(changelog).toContain("numeric collision suffix");
    expect(changelog).toContain("media_player.geosil_2");
    expect(changelog).toContain("## 0.1.114");
    expect(changelog).toContain("exact SmartThings room name");
    expect(changelog).toContain("media_player.geosil_4");
    expect(changelog).toContain("## 0.1.113");
    expect(changelog).toContain("bounded settling retries");
    expect(changelog).toContain("registry feedback loop");
    expect(changelog).toContain("observed Refresh controls");
    expect(changelog).toContain("## 0.1.112");
    expect(changelog).toContain("temporary filesystem");
    expect(changelog).toContain("logical cleanup transaction");
    expect(changelog).toContain("## 0.1.111");
    expect(changelog).toContain("duplicated room-name object IDs");
    expect(changelog).toContain("transient identifier aliases");
    expect(changelog).toContain("bounded event-driven supplement");
    expect(changelog).toContain("## 0.1.110");
    ...
    expect(changelog).toContain("Advanced `type=HUB` same-origin device-list GET");
    expect(changelog).toContain("Cupcake endpoints remain excluded from command execution");
    expect(changelog).toContain("## 0.1.96");
    expect(changelog).toContain("bounded same-origin Advanced device-list GETs");
    expect(changelog).toContain("preserving every user-supplied entity name");
