...
describe("protocol version contract", () => {
  test("keeps every Bridge and integration release surface on the packaged 0.1.104 candidate", () => {
    const expectedBridgeVersion = "0.1.104";
    ...
    expect(protocolVersion.protocol_version).toBe(4);
  });
